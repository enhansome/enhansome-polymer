...
* [Generator Polymer](https://github.com/yeoman/generator-polymer) ⚠️ Archived Yeoman generator for Polymer projects, based on the official [Starter kit](https://developers.google.com/web/tools/polymer-starter-kit/).
...
* [lit-html](https://github.com/Polymer/lit-html) ⭐ 21,772 | 🐛 717 | 🌐 TypeScript | 📅 2026-07-25 HTML templates, via JavaScript template literals.
...
* [Polydev](https://github.com/PolymerLabs/polydev) ⚠️ Archived DevTool extension.
* [Polylint](https://github.com/PolymerLabs/polylint) ⚠️ Archived Detect errors in your code.
* [Crisper](https://github.com/PolymerLabs/crisper) ⚠️ Archived Split inline scripts from an HTML file for CSP compliance.
* [WC-Loader](https://github.com/aruntk/wc-loader) ⭐ 99 | 🐛 7 | 🌐 JavaScript | 📅 2017-08-09. Webcomponents webpack loader
* [Polybuild](https://github.com/PolymerLabs/polybuild) ⚠️ Archived An all-in-one build tool for Polymer apps.
* [Polymer CDN](https://github.com/download/polymer-cdn) ⭐ 66 | 🐛 2 | 🌐 HTML | 📅 2018-10-03. Unofficial CDN for polymer components.
* [Polyup](https://github.com/PolymerLabs/polyup) ⚠️ Archived A helpful assistant for migrating from Polymer v0.5 to 1.0.
* [Synthesis](https://github.com/meteorwebcomponents/synthesis) ⭐ 28 | 🐛 6 | 🌐 JavaScript | 📅 2017-12-14 Use Polymer as the view Layer of Meteor.js
* [MWC-Layout](https://github.com/meteorwebcomponents/layout) ⭐ 5 | 🐛 1 | 🌐 HTML | 📅 2017-04-07 Control rendering of polymer components.
...
[Polymer Projects](https://github.com/abdonrd/PolymerProjects) ⭐ 82 | 🐛 1 | 📅 2019-10-08 A list of websites and apps built with Polymer

## Other awesome resources

**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,492 | 🐛 100 | 📅 2026-06-30 list!**
